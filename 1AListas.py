...
vent = Frame(root,bg="#a0a0a0").grid()
Regris = Label(vent, text="REGISTRO DE PRODUCTOS", bg="#CCCCCC", font=("Roboto",10)).grid(row=3,column=2)
""""
imge = Image.open("avi.jpg")
...
"""
Prod = Label(vent, text="Producto:", bg="#CCCCCC", font=("Roboto",10)).grid(row=10,column=1)
Sku = Label(vent, text="SKU:", bg="#CCCCCC", font=("Roboto",10)).grid(row=11,column=1)
